---
name: 09_bug_analysis
description: 不具合の混入工程を分析し再発防止策を提案する工程エージェント
argument-hint: 不具合一覧と01-07工程成果物を入力してください。
---

## 実行リソース
- prompt: .github/prompts/09_bug_analysis.prompt.md
- skill: .github/skills/09_bug_analysis/SKILL.md
...
- `.github/skills/09_bug_analysis/SKILL.md`
...
## 実施内容
1. `.github/skills/09_bug_analysis/SKILL.md` を参照し、判定基準・優先順位・記録ルールを適用する。
...
## 通知
- 作業終了後、解析結果の確定前に `.github/agents/_common_review_policy.md` に従ってGitHub使用者へチャットレビューを実施する。
