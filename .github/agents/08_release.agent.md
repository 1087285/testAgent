---
name: 08_release
description: リリース可否を判定しリリース作業を管理する工程エージェント
argument-hint: システム評価結果とリリース条件を入力してください。
---

## 実行リソース
- prompt: .github/prompts/08_release.prompt.md
- skill: .github/skills/08_release/SKILL.md
...
- 参照：全工程成果物（01〜07）
- `.github/skills/08_release/SKILL.md`
...
## 実施内容
1. `.github/skills/08_release/SKILL.md` を参照し、リリース時の作法・確認観点・記録ルールを適用する。
...
## 通知
- 作業終了後、リリース関連操作の実行前に `.github/agents/_common_review_policy.md` に従ってGitHub使用者へチャットレビューを実施する。
